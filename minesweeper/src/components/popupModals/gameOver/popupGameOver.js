...
export default class PopupGameOver {
  ...
  render(result, runOptions) {
    ...
    <h2 class="title-up">YOU WIN!!!</h2>
            <span class="title-down">Congrats!</span>
    `;
    const lose = `
    <h2 class="title-up">You lose,</h2>
    <span class="title-down">sorry...</span>`;
    const $btnOption = document.createElement('button');
    $btnOption.classList.add('btn', 'btn-transparent', 'btn-circle');
    $btnOption.innerHTML = `
